...
<div class="wp-block-dp-row-section container-fluid foo__contacts" style="background-color:#f0f0f0;">
		...
		<div class="wp-block-dp-column align-self-center" style="">
			...
			<div class="wp-block-dp-row-section container-boxed" style="">
				<div class="row three-column-layout">
					...
					<div class="wp-block-dp-column align-self-center col-lg-4" style=""><!-- wp:site-logo {"width":100,"shouldSyncIcon":false} /--></div>
					<!-- /wp:dp/column -->
					<!-- wp:dp/column {"contentAlign":"text-right","width":"half","sizeLargeTablet":"col-lg-6"} -->
					<div class="wp-block-dp-column align-self-center col-lg-6 text-right" style=""><!-- wp:dp/foo-menu-block /--><!-- wp:dp/contact-details-block /--></div>
					<!-- /wp:dp/column -->
					<!-- wp:dp/column {"contentAlign":"text-right","width":"half","sizeLargeTablet":"col-lg-2"} -->
					<div class="wp-block-dp-column align-self-center col-lg-2 text-right" style=""><!-- wp:dp/soc-follow-block /--></div>
					<!-- /wp:dp/column -->
				</div>
			</div>
			<!-- /wp:dp/row-section -->
