	...
	<div class="row related-posts-wrapper<?php if ($swiper == 'true'): ?> swiper-wrapper<?php endif; ?><?php if ($load_more == 'true'): ?> related__load-more--parent<?php endif; ?>">
		<?php
			foreach( $related_posts as $post ): 
				...
				$event_soldout = $event_details['event_soldout'] ?? '';
			...
			<div class="col<?php if (!empty($col_mob)): ?> col-<?=$col_mob?><?php endif; ?><?php if (!empty($col_tab)): ?> col-sm-<?=$col_tab?><?php endif; ?><?php if (!empty($col_desk)): ?> col-lg-<?=$col_desk?><?php endif; ?><?php if ($load_more == 'true'): ?> related-posts-wrapper--item<?php endif; ?><?php if ($swiper == 'true'): ?> swiper-slide<?php endif; ?><?php if ($load_more == 'true'): ?>  related__load-more--item<?php endif; ?><?php if ($event_done == 'true'): ?> event-done<?php endif; ?>">
				<div class="blog-post-wrap wp-block-dp-cta-card faux-link__element">
					...
					<div class="desc">
						...
						<?php if($event_details) { ?><div class="event-details" style="width:100%"><?=$event_date?> | <?=$event_time?><?php if($event_adult_price) { ?> | <?php if (get_locale() == 'lv') { ?>Pieaugušiem<?php } if (get_locale() == 'en_GB') { ?>For adult<?php } ?> £<em class="event-adult-price"><?=$event_adult_price?></em><?php } ?><?php if($event_child_price) { ?> | <?php if (get_locale() == 'lv') { ?>Bērniem<?php } if (get_locale() == 'en_GB') { ?>For kids<?php } ?> £<em class="event-child-price"><?=$event_child_price?></em><?php } ?></div><?php } ?>
						...
						<?php if ($apply == 'true') : ?><a href="#apply-form" class="btnon btn btn-more btn-more__apply fancybox-inline" style="right:20px;z-index:7!important;<?php if ($event_done == 'true'): ?>display:none!important<?php endif; ?>"><?php if (get_locale() == 'lv') { ?>Pieteikties<?php } else { ?>Apply<?php } ?></a><?php endif; ?>
					</div>
